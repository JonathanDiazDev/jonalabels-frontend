...
function InstagramIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="h-7 w-7 text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
...
export default function InstagramSection() {
  return (
    <section className="bg-white py-16 transition-colors duration-300 dark:bg-transparent sm:py-20">
      <div className="mx-auto max-w-5xl px-4">

        <h2 className="mb-10 text-center text-3xl font-medium text-stone-900 transition-colors duration-300 md:text-4xl dark:text-stone-100">
          Nuestro Instagram
        </h2>
        ...
        <div className="grid grid-cols-2 gap-1 md:grid-cols-3">
          {instagramPosts.map(({ id, imageUrl }) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 flex items-center justify-center bg-black/0 transition-colors duration-300 group-hover:bg-black/20 dark:group-hover:bg-white/10">
                <InstagramIcon />
              </div>
            </a>
          ))}
