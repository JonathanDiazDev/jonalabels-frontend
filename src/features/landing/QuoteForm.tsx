    ...
    >
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        <button
          type="submit"
          disabled={isSubmitting}
          className="flex-1 cursor-pointer rounded-full bg-stone-900 px-8 py-3.5 text-sm font-semibold text-white transition-all duration-300 hover:bg-stone-800 disabled:cursor-not-allowed disabled:opacity-70 dark:bg-stone-50 dark:text-stone-900 dark:hover:bg-stone-200"
        >
        ...
        <button
          ...
          disabled={isSubmitting}
          className="flex-1 cursor-pointer rounded-full border-2 border-[#25D366] bg-[#25D366]/10 px-8 py-3.5 text-sm font-semibold text-[#25D366] transition-all duration-300 hover:bg-[#25D366]/20 disabled:cursor-not-allowed disabled:opacity-70 dark:border-[#25D366] dark:bg-[#25D366]/10 dark:text-[#25D366] dark:hover:bg-[#25D366]/20"
        >
